...
def main(argv):
	args = get_args(argv)
	score_Cb, score_Cs, score_U, dist_T = get_scores(args['actual_directory'], args['expected_directory'])
...
def get_scores(act_dir, exp_dir):
	...
	return score_Cb, score_Cs, score_U, dist_T

def reorder_nodes(T, perm):
	for node in T.traverse():
		node.name = str(perm[int(node.name)])
